...
scribepad is a local-first markdown editor designed for people who think in
plain text and want an AI collaborator that actually understands the whole
document, not just the cursor line.

## Why

Most markdown editors treat AI as autocomplete. scribepad treats Claude as a
